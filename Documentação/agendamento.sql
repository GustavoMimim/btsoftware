...
-- Copiando dados para a tabela agendamento.usuario: ~3 rows (aproximadamente)
...
INSERT INTO `usuario` (`codigo`, `bairro`, `cep`, `cidade`, `cpf`, `dataNascimento`, `email`, `estado`, `funcao`, `nivelUsuario`, `nome`, `numero`, `rg`, `rua`, `senha`, `telefone`, `usuario`) VALUES
	(1, 'centro', '18860-000', 'Timburi', '12312312312', NULL, 'lucas@gmail.com', 'Paraná', 'Estagiario', 'Administrador', 'Lucas Oliveira da Cruz', 15, '12312312', 'Rua Rio Teste', '', '123123123', 'locrz'),
	(2, 'dos dinos', '0000000', 'rio branco', '4817960584', NULL, 'jooj@gmail.com', '', 'Function', 'Administrador', 'Joao Marcos Tomaz', 35, '12314122', 'Rua dos Projetos', '', '99867544', 'jooh'),
	(3, 'centro', '18860000', 'Timburi', '123412341', NULL, 'mateus@gmail.com', 'Paraná', 'Atendente', 'Administrador', 'Mateus Zurdo', 11, '12331234', 'sitio', 'test', '12345678', 'zurdo');
